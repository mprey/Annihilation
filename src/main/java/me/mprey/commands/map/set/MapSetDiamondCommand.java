 ...
 */
public class MapSetDiamondCommand extends MapSetCommand {

    public MapSetDiamondCommand(Annihilation instance) {
        super(instance);
    }
    ...
    public boolean execute(CommandSender sender, ArrayList<String> args) {
        ...
        if (!getInstance().getMapManager().isMap(input)) {
            ...
            map.addDiamond(((Player) sender).getLocation());
            sender.sendMessage(ChatWriter.write(Annihilation._l("success.map.added_diamond")));
        }
        return false;
    }
